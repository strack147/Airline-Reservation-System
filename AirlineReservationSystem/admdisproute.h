...
namespace AirlineReservationSystem {
	...
	/// <summary>
	/// Summary for admdisproute
	/// </summary>
	public ref class admdisproute : public System::Windows::Forms::Form
	{
	public:
		admdisproute(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(admdisproute::typeid));
			...
			this->dataGridView1->Location = System::Drawing::Point(11, 23);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->ReadOnly = true;
			this->dataGridView1->RowHeadersWidth = 4;
			this->dataGridView1->Size = System::Drawing::Size(587, 264);
			this->dataGridView1->TabIndex = 0;
			// 
			// disp_but
			// 
			this->disp_but->Location = System::Drawing::Point(256, 293);
			this->disp_but->Name = L"disp_but";
			this->disp_but->Size = System::Drawing::Size(89, 43);
			this->disp_but->TabIndex = 1;
			this->disp_but->Text = L"Display";
			this->disp_but->UseVisualStyleBackColor = true;
			this->disp_but->Click += gcnew System::EventHandler(this, &admdisproute::disp_but_Click);
			// 
			// back_but
			// 
			this->back_but->Location = System::Drawing::Point(256, 351);
			...
			this->back_but->Click += gcnew System::EventHandler(this, &admdisproute::back_but_Click);
			// 
			// admdisproute
			// 
			...
			this->ClientSize = System::Drawing::Size(611, 420);
